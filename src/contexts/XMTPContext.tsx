...
// Database encryption key for V3 local database (required for V3)
const DATABASE_ENCRYPTION_KEY = new Uint8Array([
    ...
    const handleXMTPRegistration = async (signer: Signer) => {
      ...
      try {
        ...
        const xmtpClient = await Client.build(signer, { 
          ...
          dbEncryptionKey: DATABASE_ENCRYPTION_KEY // Required for V3
        });
