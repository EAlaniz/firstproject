...
import WalkRunClubs from './components/WalkRunClubs';
...
function App() {
  ...
  const [showWalkRunClubs, setShowWalkRunClubs] = useState(false);
  ...
  const ModalsAndOverlays = (
    <>
      ...
      <WalkRunClubs 
        isOpen={showWalkRunClubs} 
        onClose={() => setShowWalkRunClubs(false)} 
      />
    </>
  );
